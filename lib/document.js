...
var Document = /*#__PURE__*/function () {
  ...
  _createClass(Document, [{
    ...
    value: function save() {
      ...
      this.lastUpdated = new Date(); // TODO Should emit something maybe to notify this is a new Document
      // if (!this.id) {
      // }
    ...
    value: function remove() {
      ...
      return new Promise(function (resolve, reject) {
        if (!_this3.rev) {
          reject(new Error("Remove failed, 'rev' needs to be supplied"));
          return;
        }
    ...
    value: function serialise() {
      ...
      var attachements = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;
      var serialised = {};
    ...
    value: function toJSON() {
      var attachements = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
